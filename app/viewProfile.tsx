          ...
          <View style={styles.lowerProfileContainer}>
            ...
            <View style={{ width: '100%' }}>
              <View style={styles.recordSection}>
                ...
                <View style={styles.recordContainer}>
                  <View style={styles.records}>
                    <Text style={styles.recordValue}>{user?.jobsDone || 0}</Text>
                    <Text style={styles.recordLabel}>Jobs Done</Text>
                  </View>
                  <View style={styles.records}>
                    <Text style={styles.recordValue}>{user?.workerRating || 0}</Text>
                    <Text style={styles.recordLabel}>Rating</Text>
                  </View>
                  <View style={styles.records}>
                    <Text style={styles.recordValue}>{user?.jobCompletion || 0}%</Text>
              ...
              <View style={styles.recordSection}>
                ...
                <View style={styles.recordContainer}>
                  <View style={styles.records}>
                    <Text style={styles.recordValue}>{user?.jobsPosted || 0}</Text>
                    <Text style={styles.recordLabel}>Jobs Posted</Text>
                  </View>
                  <View style={styles.records}>
                    <Text style={styles.recordValue}>{user?.clientRating || 0}</Text>
                    <Text style={styles.recordLabel}>Rating</Text>
                  </View>
                  <View style={styles.records}>
                    <Text style={styles.recordValue}>{user?.transactionCompletion || 0}%</Text>
              ...
              <View style={styles.scheduleWrapper}>
                <View style={styles.days}>
                  {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((day, i) => (
                    <Text key={i} style={styles.daysLabel}>{day}</Text>
                  ))}
                </View>
                <View style={styles.days}>
                  {['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'].map((day, i) => (
                    <View
                      ...
                      style={[
                        styles.slotBox,
                        user?.availability?.[day] !== '-' && styles.slotActive
                      ]}
                    >
                      <Text style={[
                        styles.slotText,
                        user?.availability?.[day] !== '-' && styles.slotTextActive
                      ]}>
